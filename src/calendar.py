...
def _lottery_list(entries: list[tuple[dict, datetime, datetime]], now: datetime, view: str = "active") -> str:
    ...
    for item, start, deadline in active:
        ...
        cards.append(
            ...
            f'<div class="tags">{tag_html}</div><a class="apply-link" href="{url}" target="_blank" rel="noreferrer">\U0001f310 Web\u3067\u5fdc\u52df\u3059\u308b</a>'
            f'<p class="application-url"><b>\U0001f517 \u5fdc\u52df\u5148URL</b><a href="{url}" target="_blank" rel="noreferrer">{url}</a></p></article>'
        )
    filters = ''
    guidance = '\u5fdc\u52df\u6761\u4ef6\u306f\u5404\u30ab\u30fc\u30c9\u306b\u8868\u793a\u3057\u3066\u3044\u307e\u3059\u3002\u60c5\u5831\u5143\u306b\u660e\u8a18\u3055\u308c\u305f\u3082\u306e\u3060\u3051\u63b2\u8f09\u3057\u307e\u3059\u3002' if is_active else '\u958b\u59cb\u65e5\u6642\u3092\u78ba\u8a8d\u6e08\u307f\u306e\u60c5\u5831\u3067\u3059\u3002\u958b\u59cb\u6642\u523b\u3092\u904e\u304e\u308b\u3068\u300c\u53d7\u4ed8\u4e2d\u306e\u62bd\u9078\u300d\u3078\u79fb\u308a\u307e\u3059\u3002'
    card_styles = '<style>.lottery-card{padding:14px 15px 13px}.lottery-card h3{margin:3px 0 9px;font-size:1rem;line-height:1.45}.lottery-card .period{display:flex;flex-wrap:wrap;gap:5px;align-items:center;color:#374151;font-size:.82rem;margin:6px 0}.apply-link{display:block;margin-top:10px;padding:10px;text-align:center;text-decoration:none;border-radius:8px;background:#2563eb;color:#fff;font-weight:800}.application-url{margin:9px 1px 0;font-size:.75rem;line-height:1.45;overflow-wrap:anywhere;color:#4b5563}.application-url b{display:block;color:#374151}.application-url a{color:#1d4ed8;text-decoration:underline}</style>'
