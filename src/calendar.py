...
.current{{margin:22px 0 34px}}.lottery-card{{display:block;border:1px solid var(--event);border-left:7px solid var(--event-text);border-radius:10px;margin:9px 0;background:var(--event)}}.lottery-card summary{{cursor:pointer;list-style:none;padding:12px}}.lottery-card summary::-webkit-details-marker{{display:none}}.lottery-card summary strong{{display:inline-block;margin-right:8px;color:var(--event-text)}}.lottery-card summary .period{{display:flex;gap:6px;align-items:center;color:#374151;font-size:.82rem;margin:6px 0}}.period i{{font-style:normal;border-radius:4px;background:#ffffffa8;color:var(--event-text);font-weight:800;padding:2px 5px}}.period em{{font-style:normal;color:#6b7280;font-size:1rem}}.lottery-card summary b{{font-size:.94rem}}.lottery-card .detail{{margin:0 10px 10px}}
...
</style></head><body><main><h1>\u30ab\u30fc\u30c9\u62bd\u9078\u30ab\u30ec\u30f3\u30c0\u30fc</h1><p class="sub">\u958b\u59cb\u65e5\u3068\u7d42\u4e86\u65e5\u304c\u78ba\u8a8d\u3067\u304d\u305f\u62bd\u9078\u3060\u3051\u3092\u63b2\u8f09\u3057\u307e\u3059\u3002</p>{_lottery_list(entries, now)}<h2>\u53d7\u4ed8\u671f\u9593\u30ab\u30ec\u30f3\u30c0\u30fc</h2>{body}</main><script>const target=document.querySelector(location.hash);if(target&&target.tagName==='DETAILS'){{target.open=true;setTimeout(()=>target.scrollIntoView({{block:'center'}}),0);}}</script></body></html>'''
